...
import img1 from "../../../asstes/images/videoimg1.jpg";
export default function SoundChatTalkShowMonday() {
  return (
    <>
      <HeaderTopSection />
      <HeaderBottamSection />
              ...
              <Row>
                <Col xs={12} sm={12} md={6} lg={2}>
                  <div className="img-recap">
                    {/* <NavLink to="/SoundChatTalkShowMonday"> */}
                    <img src={img1} alt="" />
                    {/* </NavLink> */}
                    <div className="reacp-contnent">
                      <p className="recap-pra">
                        2021-12-20 <br /> SoundChat Talk
                      </p>
                    </div>
                  </div>
                </Col>
