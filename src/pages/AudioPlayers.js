...
export default function AudioPlayers(props) {
  ...
  useEffect(() => {
    // props.locationChange(window.location.pathname)
    ...
    <>
      {location.pathname === "/" ? (
                ...
                <div className="d-flex right-div-section">
                  ...
                  <div className="logo-text-heading">
                    ...
                    <div className="top-head-section">
                      <p>{day}</p>
                      <p className="todu">
                        {ShowTimeData.show_start_date} -{" "}
                        {ShowTimeData.show_end_date}
                      </p>
                    </div>
        ...
        <>
          ...
          >
            <div
              className="audio_start"
              style={{
                borderBottomLeftRadius:
                  displaystatus === "none" ? "50px" : "0px",
                borderBottomRightRadius:
                  displaystatus === "none" ? "50px" : "0px",
              }}
            >
              <div className="audio_start1" style={{ display: displaystatus }}>
                <div className="header-top">
                  <div className="header-top-wrapper-bottom d-flex">
                    {/* <div className="header-section-one">
            <div className="video-section">
              <video className="video-div" autoPlay={true} loop muted>
                <source src={video} type="video/mp4" />
                    ...
                    <div className="header-section-bottom">
                      <div className="d-flex right-div-section-bottom">
                        <div className="logo-soundchat">
                          <img
                            src={
                              "https://app.soundchatradio.com/soundradiobackend/images/podcast/" +
